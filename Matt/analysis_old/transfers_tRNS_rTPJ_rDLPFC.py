...
tRNS_rTPJ_punishment_transfers = []
tRNS_rTPJ_non_punishment_transfers = []
tRNS_rDLPFC_punishment_transfers = []
tRNS_rDLPFC_non_punishment_transfers = []
sham_punishment_transfers = []
sham_non_punishment_transfers = []
for i in range(0,len(allConditionPermutation)):
    if (allConditionPermutation[i].stimType == "tRNS"
            and allConditionPermutation[i].location == "rTPJ"):
        tRNS_rTPJ_punishment_transfers = tRNS_rTPJ_punishment_transfers + allConditionPermutation[i].punishmentChoices
        tRNS_rTPJ_non_punishment_transfers = tRNS_rTPJ_non_punishment_transfers + allConditionPermutation[i].nonPunishmentChoices
    elif (allConditionPermutation[i].stimType == "tRNS"
            and allConditionPermutation[i].location == "rDLPFC"):
        tRNS_rDLPFC_punishment_transfers = tRNS_rDLPFC_punishment_transfers + allConditionPermutation[i].punishmentChoices
        tRNS_rDLPFC_non_punishment_transfers = tRNS_rDLPFC_non_punishment_transfers + allConditionPermutation[i].nonPunishmentChoices
...
tRNS_rTPJ_punishment_transfers1       = np.array(tRNS_rTPJ_punishment_transfers)
tRNS_rTPJ_non_punishment_transfers1   = np.array(tRNS_rTPJ_non_punishment_transfers)
tRNS_rDLPFC_punishment_transfers1     = np.array(tRNS_rDLPFC_punishment_transfers)
tRNS_rDLPFC_non_punishment_transfers1 = np.array(tRNS_rDLPFC_non_punishment_transfers)
...
tRNS_rTPJ_punishment_mean = np.mean(tRNS_rTPJ_punishment_transfers1)
tRNS_rTPJ_non_punishment_mean = np.mean(tRNS_rTPJ_non_punishment_transfers1)
tRNS_rDLPFC_punishment_mean = np.mean(tRNS_rDLPFC_punishment_transfers1)
tRNS_rDLPFC_non_punishment_mean = np.mean(tRNS_rDLPFC_non_punishment_transfers1)
sham_punishment_mean = np.mean(sham_punishment_transfers1)
sham_non_punishment_mean = np.mean(sham_non_punishment_transfers1)

tRNS_rTPJ_punishment_std = np.std(tRNS_rTPJ_punishment_transfers1)
tRNS_rTPJ_non_punishment_std = np.std(tRNS_rTPJ_non_punishment_transfers1)
tRNS_rDLPFC_punishment_std = np.std(tRNS_rDLPFC_punishment_transfers1)
tRNS_rDLPFC_non_punishment_std = np.std(tRNS_rDLPFC_non_punishment_transfers1)
sham_punishment_std = np.std(sham_punishment_transfers1)
sham_non_punishment_std = np.std(sham_non_punishment_transfers1)

tRNS_rTPJ_punishment_std_error = tRNS_rTPJ_punishment_std / 3
tRNS_rTPJ_non_punishment_std_error = tRNS_rTPJ_non_punishment_std / 3
tRNS_rDLPFC_punishment_std_error = tRNS_rDLPFC_punishment_std / 3
tRNS_rDLPFC_non_punishment_std_error = tRNS_rDLPFC_punishment_std / 3
sham_punishment_std_error = sham_punishment_std / 3
sham_non_punishment_std_error = sham_non_punishment_std / 3

means = [tRNS_rTPJ_punishment_mean,tRNS_rDLPFC_punishment_mean,sham_punishment_mean,
         tRNS_rTPJ_non_punishment_mean,tRNS_rDLPFC_non_punishment_mean,sham_non_punishment_mean]
std_errors = [tRNS_rTPJ_punishment_std_error,tRNS_rDLPFC_punishment_std_error,sham_punishment_std_error,
             tRNS_rTPJ_non_punishment_std_error,tRNS_rDLPFC_non_punishment_std_error,sham_non_punishment_std_error]
