...
##            for offer_ind in range(5):
    ...
    perm_mean_rtpj_medium = subjects_df[subject_ind][subjects_df[subject_ind].StimulationCondition.isin([1])
    ...
    perm_mean_rdlpfc_low = subjects_df[subject_ind][subjects_df[subject_ind].StimulationCondition.isin([2])
                                & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_rdlpfc_medium = subjects_df[subject_ind][subjects_df[subject_ind].StimulationCondition.isin([2])
                                & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    ...
    stim_location_means.append(perm_mean_rtpj_medium)
    stim_location_means.append(perm_mean_rtpj_high)
    stim_location_means.append(perm_mean_rdlpfc_low)
    stim_location_means.append(perm_mean_rdlpfc_medium)
    ...
    perm_mean_medium = subjects_df[subject_ind][subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    perm_mean_high = subjects_df[subject_ind][subjects_df[subject_ind].HerdType.isin([3.0])]['Conformity'].mean()
    herd_type_means.append(perm_mean_low)
    herd_type_means.append(perm_mean_medium)
    ...
    perm_mean_offer_1_low = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([1])
                            & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_offer_1_medium = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([1])
                            & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    ...
    perm_mean_offer_2_low = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([2])
                            & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_offer_2_medium = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([2])
                            & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    ...
    perm_mean_offer_3_low = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([3])
                            & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_offer_3_medium = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([3])
                            & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    ...
    perm_mean_offer_4_low = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([4])
                            & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_offer_4_medium = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([4])
                            & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
    ...
    perm_mean_offer_5_low = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([5])
                            & subjects_df[subject_ind].HerdType.isin([1.0])]['Conformity'].mean()
    perm_mean_offer_5_medium = subjects_df[subject_ind][subjects_df[subject_ind].OfferType.isin([5])
                            & subjects_df[subject_ind].HerdType.isin([2.0])]['Conformity'].mean()
